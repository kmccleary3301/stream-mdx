...
/**
 * ShadCN-style drop-in component.
 *
 * Copy this file into your app (for example: `components/ui/bottom-stick-scroll-area.tsx`)
 * and adjust import paths for `Button`, `ScrollBar`, and `cn` as needed.
 */
...
export function BottomStickScrollArea({
  ...
  const setModeBoth = useCallback((next: BottomStickMode) => {
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-3 z-20 flex justify-center">
          <Button
            ...
            className={cn(
              ...
              showJumpButton ? "translate-y-0 opacity-100 pointer-events-auto" : "translate-y-1 opacity-0 pointer-events-none",
            )}
