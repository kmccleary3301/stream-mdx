...
export const STYLE_TARGETS: StyleTarget[] = [
  ...
  { id: "list-ol", selector: "#regression-root ol", properties: [...blockProps, "--list-indent", "--list-marker-digits"] },
  { id: "list-nested-ol", selector: "#regression-root li ol", properties: [...blockProps, "--list-indent", "--list-marker-digits"] },
  { id: "list-nested-ul", selector: "#regression-root li ul", properties: [...blockProps, "--list-indent", "--list-marker-digits"] },
  {
    id: "list-ol-li",
  ...
  {
    id: "list-nested-ol-li",
    selector: "#regression-root li ol > li",
    properties: listItemProps,
    pseudo: { before: listMarkerProps },
  },
  {
  ...
  {
    id: "list-nested-ul-li",
    selector: "#regression-root li ul > li",
    properties: listItemProps,
    pseudo: { before: listMarkerProps },
  },
  ...
  {
    id: "footnotes-ol-li",
    selector: "#regression-root .footnotes ol li",
    properties: ["padding-top", "padding-left", "font-size", "color", "position"],
    pseudo: { before: ["content", "position", "top", "font-size"] },
  },
  {
    id: "footnote-backref",
    selector: "#regression-root .footnotes .footnote-backref",
    properties: ["color", "font-size", "line-height", "text-decoration-line", "text-underline-offset"],
  },
  {
