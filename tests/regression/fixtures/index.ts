...
export const REGRESSION_FIXTURES: RegressionFixture[] = [
  ...
  {
    id: "math-left-right-null-right-supported",
    title: "Math Left/Right Null-Right Supported",
    file: "math-left-right-null-right-supported.md",
    tags: ["anticipation", "math", "display"],
  ...
  {
    id: "math-left-right-nested-negative",
    title: "Math Left/Right Nested Negative",
    file: "math-left-right-nested-negative.md",
  ...
  {
    id: "math-environment-hard-stop-negative",
    title: "Math Environment Hard Stop Negative",
    file: "math-environment-hard-stop-negative.md",
    tags: ["anticipation", "math", "display", "negative"],
    requiredTextFragments: [
      "$$",
      "\\begin{matrix}",
      "structured environment pressure",
      "no optimistic environment closure",
      "Trailing prose must remain visible after the unsupported environment math.",
      "Final paragraph after the unsupported environment math case.",
    ],
    forbidSelectors: [".katex-error"],
    forbidSelectorsDuringStreaming: [".katex-error"],
    allowRawBlockMath: true,
  ...
  {
    id: "math-alignment-hard-stop-negative",
    title: "Math Alignment Hard Stop Negative",
    file: "math-alignment-hard-stop-negative.md",
    tags: ["anticipation", "math", "display", "negative"],
    requiredTextFragments: [
      "$$",
      "\\begin{align}",
      "structured alignment pressure",
      "no optimistic alignment repair",
      "Trailing prose must remain visible after the unsupported alignment math.",
    ],
    forbidSelectors: [".katex-error"],
    forbidSelectorsDuringStreaming: [".katex-error"],
    allowRawBlockMath: true,
